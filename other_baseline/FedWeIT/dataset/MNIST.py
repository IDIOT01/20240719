...
class MNISTTask:
    ...
    def getTaskDataSet(self):
        ...
        train_task_datasets = [
            MNISTDataset(data, self.transform_train)
            for data in trainDataset.task_datasets
        ]
        testDataset = myMNIST(
            root=self.root,
            train=False,
        ...
        test_task_datasets = [
            MNISTDataset(data, self.transform) for data in testDataset.task_datasets
        ]
...
class myMNIST(datasets.MNIST):
    def __init__(
        ...
        self.task_datasets = [
            [{0: da[0].clone().detach(), 1: da[1]} for da in basedataset]
        ]
