...
def load_data(train_dataset, config, client_id):
    ...
    client_datasets = dirichlet_data_partition(train_dataset, num_clients=config["num_clients"], alpha=config["dirichlet_alpha"])
    ...
    train_dataset_client, test_dataset_client = torch.utils.data.random_split(train_dataset_client, [train_size, test_size])
